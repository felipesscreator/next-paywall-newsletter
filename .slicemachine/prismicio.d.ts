 ...
 *
 */
type PostDocumentDataSlicesSlice = PostsSlice;
/**
...
export interface PostsSliceDefaultItem {
     ...
     * - **Field Type**: Rich Text
     * - **Placeholder**: *None*
     * - **API ID Path**: posts.items[].description
     * - **Documentation**: https://prismic.io/docs/core-concepts/rich-text-title
     *
     */
    description: prismicT.RichTextField;
 ...
 *
 */
export type PostsSliceDefault = prismicT.SharedSliceVariation<"default", Record<string, never>, Simplify<PostsSliceDefaultItem>>;
/**
...
declare module "@prismicio/client" {
    ...
    namespace Content {
        export type { PostDocumentData, PostDocumentDataSlicesSlice, PostDocument, AllDocumentTypes, PostsSliceDefaultItem, PostsSliceDefault, PostsSliceVariation, PostsSlice };
    }
}
